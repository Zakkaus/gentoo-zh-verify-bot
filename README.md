...
- **Cross-distro search:** `/distro <pkg>` shows a package's current version across **AUR, Arch, Debian, Ubuntu, Nixpkgs, openSUSE and Fedora** in one message, via the [Repology](https://repology.org) API.
